...
// ---- 動画（plan_intro / products は layer2。§09 training は 2026-08-05 要望で layer1 へ） -------
...
// 注意: §09 training は Layer2 対象外（2026-08-05 クライアント要望）。TrainingSection に
// 解除UI（UnlockGate）が無いため、training 行に protection:'layer2' を付けると
// youtube_id が null になり、解除手段の無い再生不能カードが並ぶ。付けないこと。
export const LOCAL_VIDEOS = [
  ...
  vid(13, 'products', '製品（プロダクト全15品）', 2, { youtube_id: '4gJvVLprXJg', status: 'published', protection: 'layer2', variant: 'long', tab_label: '全15品' }),
  ...
  vid(34, 'products', '製品（インナーケア）', 4, { youtube_id: 'cbi5ySSheBA', protection: 'layer2', status: 'published', variant: 'long', tab_label: 'インナーケア' }),
  ...
  // §13 compliance も Layer1。ComplianceSection に解除UIが無いため layer2 を付けないこと（§09 と同じ罠）。
