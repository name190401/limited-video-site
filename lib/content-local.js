 ...
 * layer2 の実 youtube_id は本ファイルに置くが、import 元は server-only の
 * lib/content.js 経由のみに限定し、出口は必ず maskVideoForLayer1 または
 * /api/plan/content とする。
 */
...
// ---- 動画（plan_intro / products / training は layer2） -------
...
export const LOCAL_VIDEOS = [
  vid(1, 'training', 'FA',           1, { subtitle: '中村佳世（なかむらかよ）', youtube_id: 'MSmZCalPv8k', status: 'published', protection: 'layer2' }),
  vid(2, 'training', 'BMT',          2, { subtitle: '高橋剛輝（たかはしこうき）', youtube_id: 'Ps3ZD2amsAw', status: 'published', protection: 'layer2' }),
  vid(3, 'training', "Woman's Life", 3, { subtitle: '阿部美道（あべはるただ）', youtube_id: 'VGE1ldPVLK8', status: 'published', protection: 'layer2' }),
  vid(4, 'training', '経済セミナー', 4, { subtitle: 'みっくん', youtube_id: 'ZC0cfGnM3RU', status: 'published', protection: 'layer2' }),
  vid(5, 'training', 'ルーツ',       5, { subtitle: '小林一貴（こばやしかずき）', youtube_id: 'n-XHJeTc2Lc', status: 'published', protection: 'layer2' }),
  vid(6, 'training', '噛み砕き',     6, { subtitle: '伴隆（ばんたかし）', youtube_id: 'H3ZscAXE4w8', status: 'published', protection: 'layer2' }),
  vid(7, 'training', 'フレッシュ',   7, { subtitle: '中村正人（なかむらまさと）', youtube_id: 'hWvsTr2v1Co', status: 'published', protection: 'layer2' }),
  vid(8, 'training', 'MAPの書き方',  8, { subtitle: 'みっくん', youtube_id: 'xj6dIKdqo1c', status: 'published', protection: 'layer2' }),
  vid(9, 'training', '福利厚生', 9, { subtitle: '丹治郁子（たんじいくこ）', youtube_id: 'B_Cd-YQ1h30', status: 'published', protection: 'layer2' }),
  vid(12, 'products', '製品（パーソナル）', 1, { youtube_id: 'tuSEuVC6SQU', status: 'published', protection: 'layer2', variant: 'short', tab_label: 'パーソナル', audio_muted: false }),
  vid(13, 'products', '製品（プロダクト全14品）', 2, { youtube_id: 'PKTwEWA5n3A', status: 'published', protection: 'layer2', variant: 'long', tab_label: 'プロダクト全14品' }),
  vid(33, 'products', '製品（BELLEQUAGE：UV入り）', 3, { youtube_id: 'XOo-ifRXVBw', protection: 'layer2', status: 'published', variant: 'long', tab_label: 'BELLEQUAGE' }),
  ...
  // §04 プラン説明（新規事業説明会）
  vid(21, 'plan_intro', '中村佳世',   1, { youtube_id: 'KUYqhhJ_VMY', status: 'published', protection: 'layer2', variant: 'long' }),
  vid(22, 'plan_intro', '竹之内尚也', 2, { youtube_id: '1Pf9pBZKcHs', status: 'published', protection: 'layer2', variant: 'long' }),
  ...
  vid(28, 'plan_intro', '【新規ABC 30分男性バージョン】', 3, { youtube_id: 'AcxykSFFl4o', status: 'published', protection: 'layer2', variant: 'short' }),
  vid(29, 'plan_intro', '【新規ABC 30分女性バージョン】', 4, { youtube_id: 'Q2aHPK7DaBE', status: 'published', protection: 'layer2', variant: 'short' }),
...
export function localProtectedVideos() {
  return LOCAL_VIDEOS
    .filter((v) => v.protection === 'layer2' && v.status === 'published' && v.youtube_id)
