...
export const LOCAL_VIDEOS = [
  vid(1, 'training', 'FA',           1, { subtitle: 'かよさん', youtube_id: 'MSmZCalPv8k', status: 'published', protection: 'layer2' }),
  vid(2, 'training', 'BMT',          2, { subtitle: 'こうきくん', youtube_id: 'Ps3ZD2amsAw', status: 'published', protection: 'layer2' }),
  vid(3, 'training', "Woman's Life", 3, { subtitle: 'はるくん', youtube_id: 'VGE1ldPVLK8', status: 'published', protection: 'layer2' }),
  vid(4, 'training', '経済セミナー', 4, { subtitle: 'みっくん', youtube_id: 'ZC0cfGnM3RU', status: 'published', protection: 'layer2' }),
  vid(5, 'training', 'ルーツ',       5, { subtitle: 'かずき', youtube_id: 'n-XHJeTc2Lc', status: 'published', protection: 'layer2' }),
  vid(6, 'training', '噛み砕き',     6, { subtitle: '尚也くん', youtube_id: 'H3ZscAXE4w8', status: 'published', protection: 'layer2' }),
  vid(7, 'training', 'フレッシュ',   7, { subtitle: '正人さん', youtube_id: 'hWvsTr2v1Co', status: 'published', protection: 'layer2' }),
  vid(8, 'training', 'MAPの書き方',  8, { subtitle: 'みっくん', youtube_id: 'xj6dIKdqo1c', status: 'published', protection: 'layer2' }),
  vid(9, 'training', '福利厚生', 9, { youtube_id: 'B_Cd-YQ1h30', status: 'published', protection: 'layer2' }),
