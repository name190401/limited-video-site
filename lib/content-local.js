...
// ---- 動画（plan_intro / plan / products / training は layer2） -
...
export const LOCAL_VIDEOS = [
  vid(1, 'training', 'FA',           1, { subtitle: 'かよさん', protection: 'layer2' }),
  vid(2, 'training', 'BMT',          2, { subtitle: 'こうきくん', protection: 'layer2' }),
  vid(3, 'training', 'ウーマン',     3, { subtitle: 'はるくん', protection: 'layer2' }),
  vid(4, 'training', '経済セミナー', 4, { subtitle: 'みっくん', protection: 'layer2' }),
  vid(5, 'training', 'ルーツ',       5, { subtitle: 'かずき', protection: 'layer2' }),
  vid(6, 'training', '噛み砕き',     6, { subtitle: '尚也くん', protection: 'layer2' }),
  vid(7, 'training', 'フレッシュ',   7, { subtitle: '正人さん', protection: 'layer2' }),
  vid(8, 'training', 'MAPの書き方',  8, { subtitle: 'みっくん', protection: 'layer2' }),
  vid(9, 'training', 'QUALIAパーク・共済（福利厚生）', 9, { subtitle: '担当未定', protection: 'layer2' }),
  vid(10, 'plan', 'ショートプラン', 1, { protection: 'layer2', variant: 'short' }),
  vid(11, 'plan', 'ロングプラン',   2, { protection: 'layer2', variant: 'long' }),
  vid(12, 'products', '製品ショート', 1, { protection: 'layer2', variant: 'short', audio_muted: true }),
  vid(13, 'products', '製品ロング',   2, { protection: 'layer2', variant: 'long' }),
