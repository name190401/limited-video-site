...
export const LOCAL_SECTIONS = [
  ...
  { key: 'faq',          title: 'よくある質問',           sort_order: 12, status: 'published', body: null },
]
...
export const LOCAL_VIDEOS = [
  ...
  vid(6, 'training', '噛み砕き',     6, { subtitle: '竹之内尚也（たけのうちなおや）', youtube_id: 'H3ZscAXE4w8', status: 'published', protection: 'layer2' }),
  ...
  vid(12, 'products', '製品（パーソナル）', 1, { youtube_id: 'tuSEuVC6SQU', status: 'published', protection: 'layer2', variant: 'short', audio_muted: false }),
  vid(13, 'products', '製品（プロダクト全14品）', 2, { youtube_id: 'PKTwEWA5n3A', status: 'published', protection: 'layer2', variant: 'long' }),
