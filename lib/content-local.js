...
export const LOCAL_VIDEOS = [
  ...
  vid(2, 'training', 'BMT',          2, { subtitle: '高橋剛輝（たかはしこうき）', youtube_id: 'Ps3ZD2amsAw', status: 'published' }),
  ...
  vid(13, 'products', '製品（プロダクト全15品）', 2, { youtube_id: '4gJvVLprXJg', status: 'published', protection: 'layer2', variant: 'long', tab_label: 'プロダクト全15品' }),
