  ...
  if (!active) {
    return (
      ...
      >
        ...
        {/* 金リング内 白 Play 三角（直径 56px） */}
        <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-14 h-14 rounded-full border border-gold-400 bg-navy-900/40 backdrop-blur-sm">
